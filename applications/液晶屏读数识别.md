...
train = './data/icdar2015/text_localization/test'
# 从指定目录中选取一张图片
...
```python
# 推理预测
python tools/infer/predict_det.py --image_dir="data/icdar2015/text_localization/test/1.jpg" --det_model_dir="./inference/det_ppocrv3/Student"
```
...
```python
# 推理预测
python tools/infer/predict_rec.py --image_dir="data/ic15_data/test/1_crop_0.jpg" --rec_model_dir="./inference/rec_ppocrv3/Student"
```
...
```python
#串联测试
python3 tools/infer/predict_system.py --image_dir="./data/icdar2015/text_localization/test/142.jpg" --det_model_dir="./inference/det_ppocrv3/Student"  --rec_model_dir="./inference/rec_ppocrv3/Student"
```
