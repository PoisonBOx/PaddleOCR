...
def main():
    test_image_dir = "data/FUNSD/testing_data/images/"
    test_anno_dir = "data/FUNSD/testing_data/annotations/"
    test_output_dir = "data/FUNSD/test.json"
    ...
    train_image_dir = "data/FUNSD/training_data/images/"
    train_anno_dir = "data/FUNSD/training_data/annotations/"
    train_output_dir = "data/FUNSD/train.json"
